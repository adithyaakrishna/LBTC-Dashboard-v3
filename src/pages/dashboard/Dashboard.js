...
export default function Dashboard(props) {
  ...
  return (
    ...
    <>
      <PageTitle title="Today's Update - 13th October 2020" color="#ffffff" />
          ...
          >
            ...
            <div className={classes.progressSection}>
              ...
              <Typography
                ...
                className={classes.progressSectionTitle}
              >
                Number of places Street Play was performed at - <span style={{ color: "#536DFE" }}>4</span>
              </Typography>
            </div>
            <div>
              <Typography
                ...
                className={classes.progressSectionTitle}
              >
                Population Reached (Approximate) - <span style={{ color: "#536DFE" }}>160</span>
              </Typography>
            </div>
            <div>
              <Typography
                ...
                className={classes.progressSectionTitle}
              >
                Total Reach (Approximate) - <span style={{ color: "#536DFE" }}>160</span>
              </Typography>
            </div>
          </Widget>
        </Grid>
          ...
          >
            ...
            <div className={classes.progressSection}>
              <Typography
                ...
                className={classes.progressSectionTitle}
              >
                No. of Houses Surveyed - <span style={{ color: "#536DFE" }}>11</span>
              </Typography>
            </div>
            <div className={classes.progressSection}>
              <Typography
                ...
                className={classes.progressSectionTitle}
              >
                No. of Individuals Covered - <span style={{ color: "#536DFE" }}>31</span>
              </Typography>
            </div>
            <div className={classes.progressSection}>
              <Typography
            ...
            <div className={classes.progressSection}>
              <Typography
                ...
                className={classes.progressSectionTitle}
              >
                No. of Children below 10 years - <span style={{ color: "#536DFE" }}>3</span>
              </Typography>
            </div><div className={classes.progressSection}>
              <Typography
                size="md"
                ...
                className={classes.progressSectionTitle}
              >
                No. of People with Disabilities - <span style={{ color: "#536DFE" }}>0</span>
              </Typography>
            </div>
            <div>
              <Typography
                ...
                className={classes.progressSectionTitle}
              >
                No. of people with Medical Comorbidities - <span style={{ color: "#536DFE" }}>2</span>
              </Typography>
              <div className={classes.progressSection}>
                <Typography
                  size="md"
                  ...
                  className={classes.progressSectionTitle}
                >
                  No. of COVID Tests done - <span style={{ color: "#536DFE" }}>0</span>
                </Typography>
              </div>
              <div className={classes.progressSection}>
                <Typography
              ...
              <div className={classes.progressSection}>
                <Typography
                  ...
                  className={classes.progressSectionTitle}
                >
                  No. of COVID Cured People - <span style={{ color: "#536DFE" }}>0</span>
                </Typography>
              </div>
            </div>
          </Widget>
